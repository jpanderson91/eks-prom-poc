...
> **Deployment Model**: In-cluster Prometheus and Grafana  
> **Best for**: Development, learning, custom configurations, full control  
> **Resource Requirements**: Moderate (requires persistent storage and compute)

**Key Components**:
- ✅ In-cluster Prometheus server with persistent storage
- ✅ Self-managed Grafana instance with custom dashboards
- ✅ Direct node and pod metrics collection
- ✅ Complete control over configuration and data retention

**📊 [View Detailed Self-Hosted Architecture →](./self-hosted-version-README.md)**

### **AWS Managed Services Architecture** ☁️
> **Deployment Model**: Amazon Managed Prometheus (AMP) + Amazon Managed Grafana (AMG)  
> **Best for**: Production, enterprise, scalability, reduced operational overhead  
> **Resource Requirements**: Minimal (serverless, AWS-managed)

**Key Components**:
- ✅ Amazon Managed Prometheus (AMP) workspace with unlimited scale
- ✅ Amazon Managed Grafana (AMG) with automated dashboard provisioning
- ✅ Serverless monitoring with pay-per-use pricing
- ✅ Enterprise security, compliance, and AWS integrations
...
**📊 [View Complete Architecture Diagrams →](./diagrams/README.md)**
